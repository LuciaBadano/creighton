...
export const DAY_TYPES = [
  { value: 'menstrual',  label: 'Menstruación',       letter: 'M',  colorKey: 'sangrado' },
  { value: 'seco',       label: 'Día seco',           letter: 'V',  colorKey: 'seco' },
  { value: 'mucus',      label: 'Moco sin fertilidad',letter: 'A',  colorKey: 'amarillo' },
  { value: 'fertil',     label: 'Moco fértil',        letter: 'B',  colorKey: 'fertil' },
  { value: 'cuspide',    label: 'Día cúspide (Pico)', letter: 'P',  colorKey: 'cuspide' },
