...
export default function CycleStrip({ cycleNumber, startDate, endDate, entries, onCellClick, isCurrentCycle }) {
    ...
    <div className={`${styles.cycle} ${isCurrentCycle ? styles.current : ''}`}>
      ...
      <div className={styles.cycleHeader}>
        <span className={styles.cycleLabel}>
          Ciclo {cycleNumber}
          {isCurrentCycle && <span className={styles.currentBadge}>en curso</span>}
        </span>
